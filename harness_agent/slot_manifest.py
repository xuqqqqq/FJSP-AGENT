    ...
    slots = [
        ...
        CodeSlotSpec(
            ...
            inputs=[
                ...
                "candidate_tabu_sequence_parts, operation_key, and setup_time_between may be used for bounded SDST memory signals",
            ],
            outputs=[
        ...
        CodeSlotSpec(
            ...
            invariants=[
                ...
                "Do not access nonexistent schedule.setup_time, schedule.index.setup_time, schedule.index.durations, or schedule.operations APIs.",
                "If setup_time_between is used, call setup_time_between(schedule.index.instance, machine_id, previous_op, current_op, schedule.index).",
                "Do not modify parser, evaluator, solution schema, CLI arguments, or benchmark semantics.",
            ],
            allowed_edits=[
