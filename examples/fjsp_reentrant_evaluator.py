...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate and score Re-entrant FJSP schedules.")
    ...
    try:
        ...
        if not instance.has_reentrant_routes:
            raise ValueError("reentrant evaluator requires an fjsp_reentrant instance")
