"""Distributed FJSP with Transfers evaluator.

Usage:
  python examples/fjsp_distributed_transfer_evaluator.py \\
    --instance <dfjspt_instance.txt> --solution <schedule.json> --metrics <out.json>
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Validate and score Distributed FJSP with Transfers schedule JSON."
    )
    ...
    try:
        ...
        schedule = load_distributed_solution(args.solution)
