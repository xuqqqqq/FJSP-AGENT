...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验并评价并行组批加工 FJSP 排程。")
    ...
    try:
        ...
        if instance.variant != "fjsp_pbpm":
            raise ValueError("PBPM evaluator requires an fjsp_pbpm instance")
