...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate and score Release-Time FJSP schedules.")
    ...
    try:
        ...
        if not instance.has_release_times:
            raise ValueError("release-time evaluator requires an fjsp_release_time instance")
