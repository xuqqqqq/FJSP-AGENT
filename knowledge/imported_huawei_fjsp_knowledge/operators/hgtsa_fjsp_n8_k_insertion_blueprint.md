...
source: knowledge/papers/xiejin_2022_hgtsa_jobshop.md
status: seed
---

## 作用

该蓝图用于把谢晋博士论文中的 FJSP HGTSA 思想转成我们项目可实现的最小版本。目标不是一次完整复现论文，而是先补上当前 Barnes smoke 缺失的强局部搜索层。
...
1. Barnes/Brandimarte 标准 FJSP 缩小 best-known gap。
2. LLM 自演进候选算子模板。
