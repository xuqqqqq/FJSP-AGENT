...
stored under `knowledge/local_papers/raw/` for local reading and retrieval, but
...
1. Read each PDF and create a short knowledge card under `knowledge/papers/` or
   `knowledge/operators/`.
